"""This script helps to convert yolo-style dataset to the mars_coco_v1 format.
...
Note:
    ...
    └── $ROOT_PATH
        ...
        │    └── ...
        └── ...
    4. After converting to mars_coco_v1, you can use the
...
def convert_bbox_info(label, idx, obj_count, image_height, image_width):
    """Convert yolo-style bbox info to the mars_coco_v1 format."""
...
def convert_yolo_to_coco(image_dir: str):
    """Convert annotations from yolo style to mars_coco_v1 style.
